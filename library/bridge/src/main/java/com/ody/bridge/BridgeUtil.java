...
public class BridgeUtil {
	...
	final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:mobileAPI._handleMessageFromNative('%s');";
	final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:mobileAPI._fetchQueue();";
	public final static String JAVASCRIPT_STR = "javascript:";

	public static String parseFunctionName(String jsUrl) {
		return jsUrl.replace("javascript:mobileAPI.", "").replaceAll("\\(.*\\);", "");
	}
